    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function lazyLoad(destiny){
            ...
            panel.find('images[data-src], images[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]').each(function(){
                element = $(this);
        ...
        */
        function destroyStructure(){
            ...
            container.find('images[data-srcset]').each(function(){
                setSrc($(this), 'srcset');
            });
